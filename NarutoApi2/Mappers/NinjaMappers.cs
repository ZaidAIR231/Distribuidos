...
{
    public static IList<NinjaResponseDto> ToResponseDto(this IReadOnlyList<Ninja> ninjas)
    => ninjas.Select(n => n.ToResponseDto()).ToList();

     public static IReadOnlyList<Ninja> ToModel(this IEnumerable<NinjaEntity> entities)
